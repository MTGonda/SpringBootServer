...
public class DoctorService {
    ...
    public DoctorDTO findPatientByImieAndNazwiskoAndSpecjalizacja(String imie, String nazwisko, String specjalizacja){
        Optional<Doctor> databaseResult = doctorRepo.findByImieAndNazwiskoAndSpecjalizacja(imie,nazwisko,specjalizacja);
        if (databaseResult.isEmpty()){
            return null;
        }
        return modelMapper.map(databaseResult.get(), DoctorDTO.class);
